		...
		const rows = props.timeSlots.map((row, index) => {
			return (
				<tr key={index}>
					...
					<td>{row.endTime}</td>
					<td>
						<button onClick={() => props.removeTimeSlot(props.dayIndex, index)}>Delete</button>
					</td>
				</tr>
			);
		});
	...
	return (
		<div className="d-flex align-content-sm-stretch flex-sm-column"
			...
			<div className="p-2" id="input_schedule_prompt">
				<span className="input_schedule_prompt">Input your weekly available time slots.</span>
			</div>
			...
			<div className="row" id="input_schedule">
				<div className="col-1" id="input_day_view">
					...
					<SlotList timeSlots={props.slotData[0]} removeTimeSlot={props.removeSlot} dayIndex={0} />
				...
				<div className="col-1" id="input_day_view">
					...
					<SlotList timeSlots={props.slotData[1]} removeTimeSlot={props.removeSlot} dayIndex={1} />
				...
				<div className="col-1" id="input_day_view">
					...
					<SlotList timeSlots={props.slotData[2]} removeTimeSlot={props.removeSlot} dayIndex={2} />
				...
				<div className="col-1" id="input_day_view">
					...
					<SlotList timeSlots={props.slotData[3]} removeTimeSlot={props.removeSlot} dayIndex={3} />
				...
				<div className="col-1" id="input_day_view">
					...
					<SlotList timeSlots={props.slotData[4]} removeTimeSlot={props.removeSlot} dayIndex={4} />
				...
				<div className="col-1" id="input_day_view">
					...
					<SlotList timeSlots={props.slotData[5]} removeTimeSlot={props.removeSlot} dayIndex={5} />
				...
				<div className="col-1" id="input_day_view">
					...
					<SlotList timeSlots={props.slotData[6]} removeTimeSlot={props.removeSlot} dayIndex={6} />
